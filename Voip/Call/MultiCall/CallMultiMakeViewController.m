...
@interface CallMultiMakeViewController () <TILCallNotificationListener, TILCallMemberEventListener, UITextFieldDelegate>
@property (nonatomic, strong) TILMultiCall *call;
@property (nonatomic, strong) NSMutableArray *indexArray;
@end

@implementation CallMultiMakeViewController
...
- (void)makeCall{
    ...
    baseConfig.memberArray = _memberArray;
